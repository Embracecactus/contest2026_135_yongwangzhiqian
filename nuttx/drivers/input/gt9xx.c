...
#define CONFIG_INPUT_GT9XX_I2C_FREQUENCY \
  CONFIG_INPUT_GT9XX_STANDARD_IOCTL_I2C_FREQUENCY

/* Default Number of Poll Waiters is 1 */

#define CONFIG_INPUT_GT9XX_NPOLLWAITERS \
  CONFIG_INPUT_GT9XX_STANDARD_IOCTL_NPOLLWAITERS
 ...
 *
 * Description:
 *   Report the standard touchscreen capabilities implemented by GT9xx.
 *
 ****************************************************************************/
