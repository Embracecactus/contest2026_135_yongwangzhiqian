...
def compile_harness(repo: Path, output: Path) -> None:
    ...
    chip = repo / "board/bk7258_t5ai/chip"
    harness = repo / "board/bk7258_t5ai/scripts/host/bk7258_ota_staging_harness.c"
    command = [
        compiler,
        "-std=c11",
        "-Wall",
...
def source_contract(repo: Path) -> None:
    paths = {
        "core": repo / "board/bk7258_t5ai/chip/cp/bk7258_ota_staging_core.c",
        "adapter": repo / "board/bk7258_t5ai/chip/cp/bk7258_ota_staging.c",
        "guard": repo / "board/bk7258_t5ai/chip/cp/bk7258_flash_guard.c",
        "kconfig": repo / "board/bk7258_t5ai/chip/Kconfig",
        "make": repo / "board/bk7258_t5ai/chip/Make.defs",
        "cmake": repo / "board/bk7258_t5ai/chip/CMakeLists.txt",
        "defconfig": repo / "board/bk7258_t5ai/configs/cp_nsh_psram/defconfig",
    }
    ...
    mtd = (repo / "board/bk7258_t5ai/chip/cp/bk7258_flash_mtd.c").read_text(
        encoding="utf-8"
    )
    require(
