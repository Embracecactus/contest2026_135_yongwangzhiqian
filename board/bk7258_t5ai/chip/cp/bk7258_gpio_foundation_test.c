...
#define BK7258_GPIOC0_LED                   GPIO_9
#define BK7258_GPIOC0_KEY                   GPIO_29
...
_Static_assert(GPIO_9 == 9,
               "GPIO C0 requires the board LED to remain on P9");
_Static_assert(GPIO_29 == 29,
               "GPIO C0 requires USERKEY to remain on P29");
                                     ...
                                     bool *seen_low)
{
  if (level)
    {
      *seen_high = true;
      printf("bkgpioc0: KEY P29 raw=1 RELEASED\n");
    }
  else
    {
      *seen_low = true;
      printf("bkgpioc0: KEY P29 raw=0 PRESSED\n");
    }
}
...
int bk7258_gpio_foundation_test(void)
{
  ...
  printf("bkgpioc0: BEGIN LED=P9 active-high KEY=P29 active-low\n");
