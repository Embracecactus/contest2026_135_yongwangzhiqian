/****************************************************************************
 * board/bk7258/chip/ap/bk7258_eth.c
 *
...
/* The SDK HAL uses HAL_ETH_GetTick() -> xTaskGetTickCount() for its reset
 * and transmit timeouts.  The FreeRTOS archive is excluded from the NuttX
 * link set, so supply the tick source board-owned.
 */
