...
- For N15, run the RBL self-test, exact-v3.1.1.9 partition/remap verifier,
  deterministic factory-manifest tests, and all existing RPTUN/BLE/PSRAM
  gates. Historical journal/SRAM tests are not deployment gates for the
  accepted layout.
