...
```text
docs/bk7258-t5ai/nuttx-port/n8-cold-reset-nsh-hang-investigation.md
docs/bk7258-t5ai/nuttx-port/n8-cold-reset-diagnostic-checkpoints.md
```
...
5. `docs/bk7258-t5ai/README.md` 的当前状态；
6. `docs/bk7258-t5ai/next-stage-prompt.md` 的 CURRENT handoff；
