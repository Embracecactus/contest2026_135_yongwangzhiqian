> **事实截止日期**：2026-08-04
> **权威来源**：[ADR-001](../../../memory/decisions/ADR-001-wrapper-only-official-source-boundary.md) · [项目规则](../../../memory/RULES.md) · [项目运维](../../../memory/OPERATIONS.md) · [board Make.defs](../../../board/bk7258_t5ai/chip/Make.defs) · [SDK bundle入口](../../../board/bk7258_t5ai/bk_idk/README.md) · [SDK静态库导入说明](../nuttx-port/sdk-static-library-import.md) · [SDK v3.1.1.9迁移报告](../nuttx-port/sdk-v3.1.1.9-migration-report.md)
...
| 功能类型 | 去哪 | 约束 |
|----------|------|------|
| 板级驱动 / 初始化 | `board/bk7258_t5ai/src` + `chip/*` | 不碰官方 NuttX 源码 |
...
| 配置 / profile | `board/bk7258_t5ai/configs/<profile>/defconfig` 与 team-owned Kconfig/Make.defs | 维护 team 配置，不改 official Kconfig |
