...
4. 打开 [`$IMPL/README.md`](../../platforms/bk7258/README.md) 和 [`$IMPL/next-stage-prompt.md`](../../platforms/bk7258/next-stage-prompt.md)，只观察它们如何承担"实施状态入口"和"恢复指针"职责，不把其中 current 细节复制到学习笔记。
...
- [`$IMPL/README.md`](../../platforms/bk7258/README.md)：实施文档入口；
- [`$IMPL/next-stage-prompt.md`](../../platforms/bk7258/next-stage-prompt.md)：当前恢复指针；
- 这些入口链接到的源码、配置、产物和证据。
