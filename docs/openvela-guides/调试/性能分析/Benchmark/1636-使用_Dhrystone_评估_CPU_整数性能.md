...
> 官方来源：[doc.openvela.com](https://doc.openvela.com/document?id=1636&version=dev-ai-contest-2026&language=cn)  
> 版本：dev-ai-contest-2026（中文）  
> 官方更新时间：2026-06-09 19:52:02  
> 本地拉取日期：2026-08-28

\[ [English](https://github.com/open-vela/docs/tree/dev-ai-contest-2026//https:/github.com/open-vela/docs/blob/dev/en/debugging_tools/performance/Benchmark/Dhrystone.md) | 简体中文 \]
...
| **指标 (Metric)**                                                           | **说明**                                |
| :------------------------------------------------------------------------ | :------------------------------------ |
| <span class="reference">Microseconds for one run through Dhrystone</span> | 执行一次 Dhrystone 主循环所需的平均时间，单位为微秒 (µs)。 |
| <span class="reference">Dhrystones per Second</span>                      | 处理器每秒可以执行的 Dhrystone 主循环次数。           |
