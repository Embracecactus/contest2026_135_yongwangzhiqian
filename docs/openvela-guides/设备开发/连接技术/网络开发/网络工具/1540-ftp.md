...
> 官方来源：[doc.openvela.com](https://doc.openvela.com/document?id=1540&version=dev-ai-contest-2026&language=cn)  
> 版本：dev-ai-contest-2026（中文）  
> 官方更新时间：2026-06-09 19:51:12  
> 本地拉取日期：2026-08-28

\[ [English](https://github.com/open-vela/docs/tree/dev-ai-contest-2026//https:/github.com/open-vela/docs/blob/dev/en/device_dev_guide/connection/network/network_tools/ftp.md) | 简体中文 \]
...
# 一、概述
  ...
  - <span class="reference">ftpd</span> 是提供 FTP 服务的服务器端程序。
...
<span class="reference">openvela</span> 端的 FTP 功能仅提供两条不带参数的命令，具体功能如下：  
...
当 <span class="reference">host</span> 端连接到 FTP 服务后，支持以下命令：  
...
使用以下命令启动 <span class="reference">ftpd</span> 服务：  
...
**注意**：
  ...
  - 建议为 <span class="reference">root</span> 用户设置复杂密码，并禁用匿名用户（<span class="reference">anonymous</span>）访问，以提升安全性。
