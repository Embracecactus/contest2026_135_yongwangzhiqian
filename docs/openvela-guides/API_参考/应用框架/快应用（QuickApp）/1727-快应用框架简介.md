...
> 官方来源：[doc.openvela.com](https://doc.openvela.com/document?id=1727&version=dev-ai-contest-2026&language=cn)  
> 版本：dev-ai-contest-2026（中文）  
> 官方更新时间：2026-06-09 19:52:54  
> 本地拉取日期：2026-08-28

\[ [English](https://github.com/open-vela/docs/tree/dev-ai-contest-2026//https:/github.com/open-vela/docs/blob/dev/en/api/framework/quickapp/basic.md) | 简体中文 \]
...
# 相关文档
  ...
  - [Feature 框架 API](https://doc.openvela.com/document?id=1717&version=dev-ai-contest-2026&language=cn) — 快应用的 Native 扩展 API（JS 与 C/C++ 互调）
