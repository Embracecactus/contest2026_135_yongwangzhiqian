...
单板引脚和 profile 以 [`boards/bk7258/`](../../../boards/bk7258/) 为准，动态验收状态以
[`progress/CURRENT.md`](../../../progress/CURRENT.md) 和对应 verification 记录为准。
...
以下内容主要追溯最初以 Tuya T5-AI 为中心的 N1–N17 移植过程。它保留原始板型和
阶段措辞；三板当前支持范围应回到本文顶部入口、维护配置和 verification 记录判断。
...
### Bootloader 逆向与对照研究（`bootloader-analysis/`）
- [full-reverse-synthesis.md](bootloader-analysis/full-reverse-synthesis.md) —— 两家 bootloader 逆向综合结论
...
- [probe.c](hardware/t5ai-core/probe/probe.c) · [probe.ld](hardware/t5ai-core/probe/probe.ld)
...
### 参考
- [Git worktree 指南](../../workflows/git-worktree-guide.md) —— 本项目 clean worktree 与 openvela 构建工作区的关系
