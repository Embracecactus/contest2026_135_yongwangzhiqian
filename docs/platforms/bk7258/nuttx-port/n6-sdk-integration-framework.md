...
`docs/platforms/bk7258/nuttx-port/n6<mod>-*.md` 记录。
...
**模块文档**：
- `$CONTEST/docs/platforms/bk7258/nuttx-port/n6a-sdk-integration-research.md` — flash SDK 集成调研
- `$CONTEST/docs/platforms/bk7258/nuttx-port/b2-wdt-fix.md` — WDT SDK 全量适配（首个落地）
