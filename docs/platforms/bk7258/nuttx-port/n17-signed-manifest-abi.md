...
The frozen public-only vector was stored at the historical path
`board/bk7258/scripts/testdata/n17_manifest_v1/vector.json`. It recorded,
without any private key, all of these values:
...
`board/bk7258/scripts/verify_bk7258_n17_manifest_vector.py` used Python's
standard library for canonical parsing and payload generation, then OpenSSL as
the independent ECDSA implementation. On 2026-08-06 it
