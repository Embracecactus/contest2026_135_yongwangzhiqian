...
- `docs/platforms/bk7258/bootloader-analysis/bk-official-bootloader-reverse.md`（908 行）— 官方 BL 主逆向
- `docs/platforms/bk7258/bootloader-analysis/full-reverse-synthesis.md`（172 行）— 综合合成
- `docs/platforms/bk7258/bootloader-analysis/tuya-bootloader-reverse.md`（761 行）— 第三方对比
- `docs/platforms/bk7258/bootloader-analysis/vendor-bootloader-comparison.md`（67 行）— vendor 对比
- `docs/platforms/bk7258/nuttx-port/n17-signed-manifest-abi.md` — **已验证 BK7258 Manifest ABI**（security_counter @0x020、slot A @0x011000、slot B @0x286000）
- `docs/platforms/bk7258/hardware/t5ai-core/probe/README.md` — 探针验证（含官方 `"BK7236\0\0"` 魔数证据）
